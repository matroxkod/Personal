...
preferences {
    ...
    input("dest_port", "text", title: "Port", description: "The port you wish to connect to to emulate a ping")
}
 

metadata {
	definition (name: "Ping", namespace: "matrox", author: "Kristopher Kubicki|MatroxKOD") {
		capability "Polling"
...
def poll() {
    ...
    //def porthex = Long.toHexString(Long.parseLong(convertPortIntToLong(dest_port)))
